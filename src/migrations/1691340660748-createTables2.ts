...
export class CreateTables21691340660748 implements MigrationInterface {
    name = 'CreateTables21691340660748'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "clients" ("id" SERIAL NOT NULL, "fullname" character varying(70) NOT NULL, "email" character varying(60) NOT NULL, "password" character varying(120) NOT NULL, "admin" boolean NOT NULL, "telephone" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_b48860677afe62cd96e12659482" UNIQUE ("email"), CONSTRAINT "PK_f1ab7cf3a5714dbc6bb4e1c28a4" PRIMARY KEY ("id"))`);
